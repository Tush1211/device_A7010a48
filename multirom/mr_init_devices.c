...
const char* mr_init_devices[] = {
    ...
    // Internal memory
    "/sys/class/block/mmcblk0p23", // /dev/block/mmcblk0p5 (system partition)
    "/sys/class/block/mmcblk0p24", // /dev/block/mmcblk0p6 (cache partition)
    "/sys/class/block/mmcblk0p25", // /dev/block/mmcblk0p7 (data partition)
